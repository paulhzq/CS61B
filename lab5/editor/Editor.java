...
public class Editor extends Application {
  ...
  public LinkedList<String> al = new LinkedList<String>();//Create arraylist for storing the input string.
  ...
  private class KeyEventHandler implements EventHandler<KeyEvent> {
      ...
      private void TopLeftText() {
          ...
          // Calculate the position so that the text will be TopLeft on the screen.
          double textTop = 0;
          double textLeft = 0;
